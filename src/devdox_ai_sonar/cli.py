...
def _profile_from_legacy_llm_config(llm_config: LLMConfig) -> LLMProfile:
    ...
    A later refactor on the CLI layer consumes the new
    ``[[llm.profiles]]`` schema directly, at which point this bridge
    goes away. Until then it maps the legacy provider name to the
    canonical litellm prefix and glues it onto the model.
    """
